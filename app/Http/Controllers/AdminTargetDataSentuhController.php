<?php namespace App\Http\Controllers;
	...
	class AdminTargetDataSentuhController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"TARGET","name"=>"TARGET"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Hunter','name'=>'Hunter','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Area','name'=>'Area','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Roda Penggerak','name'=>'Roda_Penggerak','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'TARGET','name'=>'TARGET','type'=>'number','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			# OLD END FORM
