        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class="form-group has-feedback">
               ...
               <div class="input-group date">
                  ...
                  <input type="text" name="periode" class="form-control pull-right date" id="datepicker" placeholder="Periode" required>
                </div>
                <!-- /.input group -->
            </div>
...
<script src="//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.6.1/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
<script>
